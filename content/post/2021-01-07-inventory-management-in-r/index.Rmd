...
![https://www.accountancyknowledge.com/economic-order-quantity/](/2021-01-07-inventory-management-in-r/index_files/EOQ.png){width=300px}
...
Economic Order Quantity Model is the most basic inventory management model. The required parameters for calculating EOQ is d=Demand Per Unit Time, k=Ordering Cost Per Order and h=Holding Cost Per Unit of Product.
